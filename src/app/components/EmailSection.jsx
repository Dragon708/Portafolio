...
const EmailSection = () => {
  ...
  const { text, EmailSectionref } = useContext(LenguajeContext);
  ...
  const handleSubmit = async (e) => {
    ...
    if (response.status === 200) {
      ...
      Swal.fire("SEND!", "The Email Has Been Sent!", "success");
  ...
  return (
    <section
      ...
      <div className="z-10">
        ...
        <p className="dark:text-[#ADB7BE]  text-black mb-4 max-w-md">
          {text.descripConnect}
        </p>
        <div className="socials flex flex-row gap-2">
          <Link target="_blank" href="https://github.com/Dragon708">
            <svg
          ...
          <Link
            target="_blank"
            href="https://www.linkedin.com/in/jorge-gonz%C3%A1lez-330337251/">
            <svg
              fill="currentColor"
              class="fill-current dark:text-white text-black"
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div>
        <form id="form_1" className="flex flex-col" onSubmit={handleSubmit}>
          <div className="mb-6">
            <label
              htmlFor="email"
              className="dark:text-[#ADB7BE]  text-black block mb-2 text-sm font-medium">
              {text.yourEmail}
            </label>
            <input
              name="email"
          ...
          <div className="mb-6">
            <label
              htmlFor="subject"
              className="dark:text-[#ADB7BE]  text-black block text-sm mb-2 font-medium">
              {text.subject}
            </label>
            <input
              name="subject"
          ...
          <button
            ...
            {isSending ? <Spinner color="success" /> : text.send}
          </button>
        </form>
      </div>
    </section>
